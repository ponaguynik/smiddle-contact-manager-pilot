...
public class AppealTypeController {
    ...
    public ResponseEntity<AppealType> create(@RequestBody AppealType appealType) {
    ...
    @RequestMapping(path = "/{appealId}", method = RequestMethod.PUT,
            consumes = MediaType.APPLICATION_JSON_UTF8_VALUE, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public AppealType update(@PathVariable String appealId, @RequestBody AppealType appealType) {
